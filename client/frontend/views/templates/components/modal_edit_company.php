<div class="modal fade" tabindex="-1" role="dialog" id="modal-edit-company">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                  ...
                  <div class="row">
                     <!-- Page Content -->
                    <form role="form" id='frm_company' name='frm_company' method="POST" action="<?php echo current_url();?>">
