    ...
    <script>
        $(document).ready(function() {
                		    ...
                		    "columnDefs":[
                		        {
        		                   ...
        		                   "data":"null",
        		                   "className": "dt-center",
        		                            "defaultContent":'&nbsp;<a href="#" class="dtButtons" id="moveUp"><i class="fa fa-arrow-up" title="Move Up"></i></a>'
        		                                            +'&nbsp;<a href="#" class="dtButtons" id="moveDown"><i class="fa fa-arrow-down" title="Move Down"></i></a>'
        		                                            +'&nbsp;<a href="#modal-template-forms" class="dtButtons" id="customFlds" data-toggle="modal"><i class="fa fa-list-alt" title="Manage Custom Fields"></i></a>'
        		                                            +'&nbsp;<a href="#" class="dtButtons" id="disableActivity"><i class="fa fa-minus-circle text-danger" title="Disable Activity"></i></a>'
                		        },
                                {
                                    "targets" : 3,
            ...
            var gridLocationLookup = $('#grid-froms-data').DataTable({
    	        ...
    	        "bInfo":false,
    	        "sServerMethod": "POST",
    	        "sAjaxSource": base_url+"workflow/form_fields_grid",
    	        "iDisplayLength": 15,
