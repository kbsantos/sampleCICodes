                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               View Farmer Details
                               <span class="pull-right"><a href="#modal-add-new-customer" data-toggle="modal" id="add-new-customer"><i class="fa fa-plus-circle"></i>New Template</a></span>
                            </div>
                		    ...
                		    "columnDefs":[
                		        {
        		                   ...
        		                   "data":"null",
        		                   "className": "dt-center",
        		                   "defaultContent":'&nbsp;<a href="#modal-customer-business" class="dtButtons" id="viewBisiness" data-toggle="modal"><i class="fa fa-building-o fa-fw" title="View Business"></i></a>'
        		                                   +'&nbsp;<a href="#modal-edit-customer" class="dtButtons" id="editCustomer" data-toggle="modal"><i class="fa fa-edit fa-fw" title="Edit Customer"></i></a> &nbsp;'
                		        },
                                {
                                    "targets" : 6,
